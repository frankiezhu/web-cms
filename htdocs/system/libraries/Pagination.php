...
class CI_Pagination {
	...
	var $last_link			= 'Last';
	var $uri_segment		= 3;
	var $full_tag_open		= '<div class="pagination" style="margin-left:300px"><ul>';
	...
	var $next_tag_open		= '<li class="prev page">';
	...
	function create_links()
	{
		...
		{
			$first_url = ($this->first_url == '') ? $this->base_url : $this->first_url;
			$output .= '<li class=""><a href="'.$first_url.'">'.$this->first_link.'</a></li>';
		}
		...
		{
			$output .= '<li class=""><a href="'.$first_url.'">'.$this->prev_link.'</a></li>';
		}
		...
		{
			$output .= '<li class=""><a href="">'.$this->next_link.'</a></li>';
		}
